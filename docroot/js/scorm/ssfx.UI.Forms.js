...
ScriptFX.UI.$create_WatermarkOptions = function(watermarkText,
		watermarkCssClass) {
	var $o = {};
...
ScriptFX.UI.AutoCompleteBehavior = function(domElement, options) {
	ScriptFX.UI.AutoCompleteBehavior.constructBase(this, [ domElement,
			options.id ]);
	this.$1_0 = options;
	this.$1_6 = -1;
...
ScriptFX.UI.AutoCompleteBehavior.prototype = {
	...
	$1_F : function($p0) {
		if (this.$1_0.selectedItemCSSClass != null) {
			ScriptFX.UI.Element
					.addCSSClass($p0, this.$1_0.selectedItemCSSClass);
		}
	},
	$1_10 : function() {
	...
	$1_13 : function($p0, $p1) {
		if (($p0 !== this.$1_A) || ($p0.get_state() !== 2)
				|| ($p0.get_response().get_statusCode() !== 200)) {
			return;
		}
		var $0 = $p1;
		var $1 = $0['prefix'];
	...
	$1_17 : function() {
		...
		this.$1_A = ScriptFX.Net.HTTPRequest.createRequest(
				ScriptFX.Net.HTTPRequest.createURI(this.$1_0.service, $2), 0);
		this.$1_A.invoke(Delegate.create(this, this.$1_13), $2);
	},
	$1_18 : function() {
		if (!this.$1_5) {
			this.$1_5 = true;
			this.$1_2.style.width = (this.get_domElement().offsetWidth - 2)
					+ 'px';
			this.$1_3.show();
		}
	},
	$1_19 : function() {
		if (this.$1_8 === 0) {
			this.$1_8 = window.setTimeout(Delegate.create(this, this.$1_17),
					this.$1_0.itemLookupDelay);
		}
	},
	$1_1A : function() {
		if (this.$1_8 !== 0) {
	...
	$1_1B : function($p0) {
		if (this.$1_0.selectedItemCSSClass != null) {
			ScriptFX.UI.Element.removeCSSClass($p0,
					this.$1_0.selectedItemCSSClass);
		}
	},
...
ScriptFX.UI.TextBox.prototype = {
	get_text : function() {
		var $0 = ScriptFX.UI.Behavior.getBehavior(this.get_domElement(),
...
ScriptFX.UI.WatermarkBehavior.prototype = {
	...
	get_isWatermarked : function() {
		return ScriptFX.UI.Element.containsCSSClass(this.get_domElement(),
				this.$1_0.watermarkCssClass);
	},
	$1_2 : function() {
	...
	$1_3 : function($p0) {
		var $0 = this.get_domElement();
		if (ScriptFX.UI.Element.containsCSSClass($0,
				this.$1_0.watermarkCssClass)) {
...
ScriptFX.UI.AutoCompleteBehavior.createClass(
		'ScriptFX.UI.AutoCompleteBehavior', ScriptFX.UI.Behavior);
ScriptFX.UI.AutoCompleteItemEventArgs.createClass(
		'ScriptFX.UI.AutoCompleteItemEventArgs', EventArgs);
ScriptFX.UI.AutoCompleteRequestEventArgs.createClass(
		'ScriptFX.UI.AutoCompleteRequestEventArgs', EventArgs);
ScriptFX.UI.Button.createClass('ScriptFX.UI.Button', ScriptFX.UI.Control,
		ScriptFX.UI.IAction);
ScriptFX.UI.CheckBox.createClass('ScriptFX.UI.CheckBox', ScriptFX.UI.Control,
		ScriptFX.UI.IToggle);
ScriptFX.UI.EnterKeyBehavior.createClass('ScriptFX.UI.EnterKeyBehavior',
		ScriptFX.UI.Behavior);
ScriptFX.UI.Label.createClass('ScriptFX.UI.Label', ScriptFX.UI.Control,
		ScriptFX.UI.IStaticText);
ScriptFX.UI.TextBox.createClass('ScriptFX.UI.TextBox', ScriptFX.UI.Control,
		ScriptFX.UI.IEditableText);
ScriptFX.UI.WatermarkBehavior.createClass('ScriptFX.UI.WatermarkBehavior',
		ScriptFX.UI.Behavior);
