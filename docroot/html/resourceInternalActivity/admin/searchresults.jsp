...
%>
<liferay-ui:search-container emptyResultsMessage="resourceInternalActivity.there-are-no-assets"  iteratorURL="<%=portletURL%>" delta="10" >
	...
	<liferay-ui:search-container-row 
		...
		<liferay-ui:search-container-column-text>
			<a class="newitem2" onclick="javascript:${renderResponse.namespace }selectResource('<%=assetEntry.getEntryId() %>');"><liferay-ui:message key="select" /></a>
		</liferay-ui:search-container-column-text>
	</liferay-ui:search-container-row>
...
<aui:form name="selectResourceForm" action="<%=selectResourceURL %>" method="POST" role="form">
	<aui:input type="hidden" name="assertId" value="" />
...
<script>
	function <portlet:namespace />selectResource(entryId){
		document.<portlet:namespace />selectResourceForm.<portlet:namespace />assertId.value=entryId;
		document.<portlet:namespace />selectResourceForm.submit();
