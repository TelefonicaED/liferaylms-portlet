...
<div id="myContainer" class="modulo portlet-toolbar search-form lms-tree">
	...
	<ul id="<%=idModuleUl%>">
		...
		if(course!=null && permissionChecker.hasPermission(course.getGroupCreatedId(),  Course.class.getName(),course.getCourseId(),ActionKeys.VIEW) && !course.isClosed()){
			...
			// Sacamos los modulos seleccionados en las preferencias para ver si
			// se muestran todos o solo los seleccionados
			...
			List<String> modulesList = (preferenceLmsActivitiesList.isEmpty()) ? new ArrayList<String>() : Arrays.asList(preferenceLmsActivitiesList.split(","));
