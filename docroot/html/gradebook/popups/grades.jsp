...
<aui:form  name="fn_grades" method="post" action="${updateGradesURL}" role="form">
	<aui:fieldset>
		...
		<%--<aui:input type="textarea" cols="40" rows="2" name="comments" label="offlinetaskactivity.comments" value='<%=((result!=null)&&(result.getComments()!=null))? HtmlUtil.extractText(result.getComments()) :"" %>'/>--%>
