...
<%
	...
	%>
		...
		AssetRenderer 		 assetRenderer		 = AssetRendererFactoryRegistryUtil
														.getAssetRendererFactoryByClassName(entry.getClassName())
															.getAssetRenderer(entry.getClassPK());
		...
		if(scormContentAsset!=null) {
			...
			<%
			String [] jss = {	"/liferaylms-portlet/js/scorm/sscompat.js",
			...
			for (int i = 0; i < jss.length; i++) {
				Element jsLink = renderResponse.createElement("script");
