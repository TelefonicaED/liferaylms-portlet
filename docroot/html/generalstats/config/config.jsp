...
<%
	...
	boolean showEditions = preferences.getValue("showEditions", "true").equals("true");
...
<aui:form action="<%=saveConfigurationURL %>" role="form" method="post" name="fm">
	...
	<aui:field-wrapper label="generalstats.config.showSearch" >
		...
		<aui:input type="checkbox" name="showEditions" label="generalstats.config.show-editions" value="<%=showEditions %>" checked="<%=showEditions %>"/>
