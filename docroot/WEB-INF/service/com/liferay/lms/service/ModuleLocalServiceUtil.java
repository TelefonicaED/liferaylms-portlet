...
public class ModuleLocalServiceUtil {
	...
	*/
	...
	public static boolean isUserFinished(long moduleId, long userId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().isUserFinished(moduleId, userId);
	}

	public static boolean userTimeFinished(long moduleId, long userId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
