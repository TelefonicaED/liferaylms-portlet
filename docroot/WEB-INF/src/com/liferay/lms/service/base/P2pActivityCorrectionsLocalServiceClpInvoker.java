...
public class P2pActivityCorrectionsLocalServiceClpInvoker {
	public P2pActivityCorrectionsLocalServiceClpInvoker() {
		...
		_methodName178 = "hasAllCorrectionsDoneAboutUserInP2PActivity";

		_methodParameterTypes178 = new String[] { "long", "long" };

		_methodName179 = "getCorrectionByP2PActivity";

		_methodParameterTypes179 = new String[] { "long" };

		_methodName180 = "getAVGCorrectionsResults";

		_methodParameterTypes180 = new String[] { "long" };

		_methodName181 = "isP2PAsignationDone";
