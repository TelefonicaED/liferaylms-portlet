...
/**
 * The base implementation of the course competence local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.lms.service.impl.CourseCompetenceLocalServiceImpl}.
 * </p>
 *
 * @author TLS
 ...
 * @generated
 */
public abstract class CourseCompetenceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CourseCompetenceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.lms.service.CourseCompetenceLocalServiceUtil} to access the course competence local service.
	 */
	...
	public CourseCompetence addCourseCompetence(
		CourseCompetence courseCompetence) throws SystemException {
		courseCompetence.setNew(true);

		return courseCompetencePersistence.update(courseCompetence, false);
	}
	 ...
	 */
	public CourseCompetence createCourseCompetence(long CourcompetenceId) {
		return courseCompetencePersistence.create(CourcompetenceId);
	}
	...
	public CourseCompetence deleteCourseCompetence(long CourcompetenceId)
		throws PortalException, SystemException {
		return courseCompetencePersistence.remove(CourcompetenceId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CourseCompetence deleteCourseCompetence(
		CourseCompetence courseCompetence) throws SystemException {
		return courseCompetencePersistence.remove(courseCompetence);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CourseCompetence.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return courseCompetencePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return courseCompetencePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CourseCompetence fetchCourseCompetence(long CourcompetenceId)
		throws SystemException {
		return courseCompetencePersistence.fetchByPrimaryKey(CourcompetenceId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CourseCompetence getCourseCompetence(long CourcompetenceId)
		throws PortalException, SystemException {
		return courseCompetencePersistence.findByPrimaryKey(CourcompetenceId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return courseCompetencePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CourseCompetence> getCourseCompetences(int start, int end)
		throws SystemException {
		return courseCompetencePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCourseCompetencesCount() throws SystemException {
		return courseCompetencePersistence.countAll();
	}
	...
	public CourseCompetence updateCourseCompetence(
		CourseCompetence courseCompetence) throws SystemException {
		return updateCourseCompetence(courseCompetence, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public CourseCompetence updateCourseCompetence(
		CourseCompetence courseCompetence, boolean merge)
		throws SystemException {
		courseCompetence.setNew(false);

		return courseCompetencePersistence.update(courseCompetence, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.lms.model.CourseCompetence",
			courseCompetenceLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = courseCompetencePersistence.getDataSource();
	...
	private CourseCompetenceLocalServiceClpInvoker _clpInvoker = new CourseCompetenceLocalServiceClpInvoker();
}