...
/**
 * The base implementation of the audit logger remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.lms.service.impl.AuditLoggerServiceImpl}.
 * </p>
 *
 * @author TLS
 * @see com.liferay.lms.service.impl.AuditLoggerServiceImpl
 * @see com.liferay.lms.service.AuditLoggerServiceUtil
 * @generated
 */
public abstract class AuditLoggerServiceBaseImpl extends BaseServiceImpl
	implements AuditLoggerService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.lms.service.AuditLoggerServiceUtil} to access the audit logger remote service.
	 */
	...
	private AuditLoggerServiceClpInvoker _clpInvoker = new AuditLoggerServiceClpInvoker();
}