...
public class P2pActivityLocalServiceClpInvoker {
	public P2pActivityLocalServiceClpInvoker() {
		...
		_methodName144 = "findByActIdAndUserId";

		_methodParameterTypes144 = new String[] { "long", "long" };

		_methodName145 = "existP2pAct";

		_methodParameterTypes145 = new String[] { "long", "long" };

		_methodName146 = "findByActId";

		_methodParameterTypes146 = new String[] { "long" };

		_methodName147 = "findByActId";

		_methodParameterTypes147 = new String[] { "long", "int", "int" };

		_methodName148 = "findByActIdOrderByP2pId";

		_methodParameterTypes148 = new String[] { "long" };

		_methodName149 = "getUsersToCorrectP2P";

		_methodParameterTypes149 = new String[] {
				"long", "long", "int", "java.util.Calendar"
			};

		_methodName150 = "getP2pActivitiesToCorrect";
