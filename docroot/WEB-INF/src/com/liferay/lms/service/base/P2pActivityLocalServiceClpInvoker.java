...
public class P2pActivityLocalServiceClpInvoker {
	public P2pActivityLocalServiceClpInvoker() {
		...
		_methodName166 = "findByActIdAndUserId";

		_methodParameterTypes166 = new String[] { "long", "long" };

		_methodName167 = "existP2pAct";

		_methodParameterTypes167 = new String[] { "long", "long" };

		_methodName168 = "findByActId";

		_methodParameterTypes168 = new String[] { "long" };

		_methodName169 = "findByActId";

		_methodParameterTypes169 = new String[] { "long", "int", "int" };

		_methodName170 = "countByActId";

		_methodParameterTypes170 = new String[] { "long" };

		_methodName171 = "findByActIdOrderByP2pId";

		_methodParameterTypes171 = new String[] { "long" };

		_methodName172 = "getUsersToCorrectP2P";

		_methodParameterTypes172 = new String[] {
				"long", "long", "int", "java.util.Calendar"
			};

		_methodName173 = "getP2pActivitiesToCorrect";

		_methodParameterTypes173 = new String[] { "long", "long", "int" };

		_methodName174 = "findByUserId";

		_methodParameterTypes174 = new String[] { "long" };

		_methodName175 = "getP2PActivitiesInDay";

		_methodParameterTypes175 = new String[] { "java.util.Calendar" };

		_methodName176 = "getNumCorrectsByDayP2P";

		_methodParameterTypes176 = new String[] { "long", "java.util.Calendar" };

		_methodName177 = "addP2pActivity";

		_methodParameterTypes177 = new String[] {
				"com.liferay.lms.model.P2pActivity"
			};

		_methodName178 = "updateP2pActivity";
