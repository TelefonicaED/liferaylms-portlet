...
/**
 * The base implementation of the user competence local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.lms.service.impl.UserCompetenceLocalServiceImpl}.
 * </p>
 *
 * @author TLS
 ...
 * @generated
 */
public abstract class UserCompetenceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserCompetenceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.lms.service.UserCompetenceLocalServiceUtil} to access the user competence local service.
	 */
	...
	public UserCompetence addUserCompetence(UserCompetence userCompetence)
		throws SystemException {
		userCompetence.setNew(true);

		return userCompetencePersistence.update(userCompetence, false);
	}
	 ...
	 */
	public UserCompetence createUserCompetence(long usercompId) {
		return userCompetencePersistence.create(usercompId);
	}
	...
	public UserCompetence deleteUserCompetence(long usercompId)
		throws PortalException, SystemException {
		return userCompetencePersistence.remove(usercompId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public UserCompetence deleteUserCompetence(UserCompetence userCompetence)
		throws SystemException {
		return userCompetencePersistence.remove(userCompetence);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(UserCompetence.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return userCompetencePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userCompetencePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public UserCompetence fetchUserCompetence(long usercompId)
		throws SystemException {
		return userCompetencePersistence.fetchByPrimaryKey(usercompId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserCompetence getUserCompetence(long usercompId)
		throws PortalException, SystemException {
		return userCompetencePersistence.findByPrimaryKey(usercompId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userCompetencePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<UserCompetence> getUserCompetences(int start, int end)
		throws SystemException {
		return userCompetencePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getUserCompetencesCount() throws SystemException {
		return userCompetencePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UserCompetence updateUserCompetence(UserCompetence userCompetence)
		throws SystemException {
		return updateUserCompetence(userCompetence, true);
	}
	...
	public UserCompetence updateUserCompetence(UserCompetence userCompetence,
		...
		return userCompetencePersistence.update(userCompetence, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.lms.model.UserCompetence",
			userCompetenceLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userCompetencePersistence.getDataSource();
	...
	private UserCompetenceLocalServiceClpInvoker _clpInvoker = new UserCompetenceLocalServiceClpInvoker();
}