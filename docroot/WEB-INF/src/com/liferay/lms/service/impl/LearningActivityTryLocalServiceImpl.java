...
public class LearningActivityTryLocalServiceImpl extends LearningActivityTryLocalServiceBaseImpl {
	...
	public com.liferay.lms.service.persistence.LearningActivityTryPersistence getPersistence(){
	...
	{
		java.util.List<LearningActivityTry> userTries= getPersistence().findByact_u(actId, userId);
		LearningActivity larn=LearningActivityLocalServiceUtil.getLearningActivity(actId);
		for(LearningActivityTry userTry:userTries)
		{
			
			//this.deleteLearningActivityTry(userTry.getLatId());
			getPersistence().remove(userTry.getLatId());
	...
	public LearningActivityTry createLearningActivityTry(long actId,ServiceContext serviceContext) throws SystemException, PortalException
	{
		...
		getPersistence().update(larnt, true);
	...
	{ 
		...
		if(PropsUtil.get("persistencemethod").equals(String.valueOf("Cassandra"))){
			...
			List<LearningActivityTry> activities = getPersistence().findByact(actId,QueryUtil.ALL_POS,QueryUtil.ALL_POS);
